...
/**
 * This table presents diamond htis associated with the selected genes.
 * It was implemented alongside the SimpleTable component to replace the deprecated Bootstrap table.
 * This needs to be updated to use UseState Hooks.
 */
class RichTable extends Component<Props, State> {
    ...
    filterRows(rows: {[key: string]: any }[]) {
                ...
                <div className="table-responsive mt-2">
                    <Table striped bordered hover>
                        ...
                        {pagedRows && pagedRows.map((each, idx) => (
                            <tr key={idx}>
                                {this.props.passClick && <td><Button size="sm" onClick={() => this.props.passClick([each['g_name']])}><i className="bi bi-search"></i></Button></td>}
