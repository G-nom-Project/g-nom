...
class FilterUI extends React.Component<Props, State> {
    ...
    passContigs(e: any): void {
        ...
        this.setState({ c_searched: new_keys }, () => {
            const values = {
                show_unassinged: this.state.show_unassigned,
                e_value: this.state.e_value,
                g_searched: this.state.g_searched,
                c_searched: this.state.c_searched,
            };
            this.props.sendValuesUp(values);
        });
    }
            ...
            <>
                ...
                <Card className="m-2">
                    <Card.Body>
                        ...
                        />
                        <Form.Label>
                            e-value {'<'} {this.state.e_value}
                        </Form.Label>
                        <Form.Range min={0} max={300} step={1} defaultValue={0} onChange={(e: any) => this.setEValue(e.target.value)} />
