...
import { fetchTaxaminerSettings } from '../../api';
...
class SelectionView extends React.Component<Props, State> {
    constructor(props: any) {
        ...
        this.state = {
            ...
            grouped_fields: {},
            has_loaded: false,
            gene_pos: 'Select a gene to get started',
            coord_type: 'J',
        };
    }
                ...
                <Card.Body>
                    <Card.Title className="d-flex justify-content-between align-items-center">
                        ...
                        {this.props.row.plot_label === 'Unassigned' && (
                            <Badge bg="warning" className="sm me-auto">
                                Unassigned
                            </Badge>
                        )}
                        <OverlayTrigger
                            overlay={
                                <Tooltip id={'tooltip-custom-fields'}>Select additional columns generated by taXaminer to be displayed below</Tooltip>
                            }
                        >
                            <Button className="sm m-2 mr-auto" onClick={this.showModal} type="submit">
                                <span className="bi bi-list-ul m-2" />
                                    ...
                                    <Row>
                                        <Col md="auto">
                                            <InputGroup className="m-2">
                                                ...
                                                <Button
                                                    onClick={() => {
                                                        navigator.clipboard.writeText(this.props.row.g_name);
                                                    }}
                                                >
                                        ...
                                        <Col md="auto">
                                            <InputGroup className="m-2">
                                                ...
                                                <Button
                                                    onClick={() => {
                                                        navigator.clipboard.writeText(this.props.row.c_name);
                                                    }}
                                                >
                                                    <span className="bi bi-clipboard2" />
                                                </Button>
                                            ...
                                            <InputGroup className="m-2">
                                                ...
                                                <Button
                                                    ...
                                                    href={
                                                        ...
                                                        this.props.row.best_hitID.toString()
                                                    }
                                                    target="_blank"
                                                >
                                        ...
                                        <Col xs={5}>
                                            <InputGroup className="m-2">
                                                ...
                                                <Button
                                                    ...
                                                    variant="secondary"
                                                    onClick={() => {
                                                        this.nextCoordFormat();
                                                    }}
                                                >
                                                    {this.state.coord_type}
                                                </Button>
                                                <Button
                                                    disabled={!this.props.gene_pos_supported}
                                                    onClick={() => {
                                                        navigator.clipboard.writeText(this.state.gene_pos);
                                                    }}
                                                >
                                                    <span className="bi bi-clipboard2" />
                                                </Button>
                                        ...
                                        <Accordion.Item eventKey="0">
                                            ...
                                            <Accordion.Body>
                                                <pre className="pre-scrollable">
                                                    <code>{JSON.stringify(this.props.row, null, 2)}</code>
                                                </pre>
                                            </Accordion.Body>
                                        </Accordion.Item>
                                    </Accordion>
                            ...
                            <Row>
                                <Col className="m-2">
                                    ...
                                    <Button
                                        className="mt-2"
                                        onClick={() => {
                                            navigator.clipboard.writeText(this.props.aa_seq);
                                        }}
                                    >
                                        <span className="bi bi-clipboard2" /> Copy sequence to clipboard
                                    </Button>
                                </Col>
                            </Row>
                        </Tab>
