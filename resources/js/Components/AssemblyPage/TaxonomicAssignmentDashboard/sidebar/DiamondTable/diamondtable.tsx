...
class Table extends Component<Props, State> {
    ...
    componentDidUpdate(prev_props: any): void {
        if (prev_props.row !== this.props.row) {
            ...
            fetchTaxaminerDiamond(this.props.assembly_id, this.props.dataset_id, this.props.row[fasta_col]).then((data: any) => {
            ...
            <>
                <Row>
                    ...
                    <Modal show={this.state.show_field_modal} handleClose={this.hideModal}>
                        ...
                        <Modal.Body>
                            <ColumnSelector set_fields={this.handleFieldsChange} default_fields={this.state.custom_fields} />
                        </Modal.Body>
                        <Modal.Footer>
