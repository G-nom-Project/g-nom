        ...
        if (data.length !== 0) {
            for (let i = 0; i < data.length; i++) {
                ...
                const pca_cones = {
                    ...
                    x: real_pca_x.map((each) => {
                        return parseFloat(each) - parseFloat(each) * 0.01;
                    }),
                    y: real_pca_y.map((each) => {
                        return parseFloat(each) - parseFloat(each) * 0.01;
                    }),
                    z: real_pca_z.map((each) => {
                        return parseFloat(each) - parseFloat(each) * 0.01;
                    }),
                    u: cone_x,
                    v: cone_y,
                ...
                <Col xs={4}>
                    <Card className="mt-2">
                        ...
                        <Card.Body>
                            ...
                            <Card.Subtitle className="text-muted mb-2">{this.state.selected_label}</Card.Subtitle>
